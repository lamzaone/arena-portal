...
- Token cost: 5,476 input · 1,143 output
...
## Knowledge Gaps
- **834 isolated node(s):** `ActivateVipMembershipItemInput`, `ActivateVipMembershipItemResult`, `AddStaffCustomCrateLootEntryInput`, `AddStaffCustomCrateLootEntryResult`, `AdminAuthorization` (+829 more)
...
- **What connects `ActivateVipMembershipItemInput`, `ActivateVipMembershipItemResult`, `AddStaffCustomCrateLootEntryInput` to the rest of the system?**
