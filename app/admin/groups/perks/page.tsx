...
const errors: Record<string, string> = {
  ...
  group_not_found: "Choose an enabled Arena custom group for this server scope.",
  membership_authority_unavailable: "Arena group membership could not be verified. No group perk change was saved.",
  membership_authority_invalid: "Arena returned an invalid group membership expiry. Review the authority data before retrying.",
