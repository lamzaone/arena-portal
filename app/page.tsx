    ...
    <PortalShell authenticated={Boolean(session)} className="home-page">
        ...
        <section className="mode-intro" id="modes" aria-labelledby="modes-title">
          ...
          <div className="tapped-bento">
            ...
            <article className="bento-card bento-loadout hero-reveal hero-delay-one"><div className="bento-index">04 <span>INVENTORY</span></div><div className="bento-icon"><Paintbrush aria-hidden="true" /></div><h3>Earn. Unbox. Equip.</h3><p>Build a personal collection with Tokens, drops, crates, and tradable cosmetics.</p><Link href={session ? "/inventory" : "/api/auth/steam"}>Open inventory <ArrowRight aria-hidden="true" /></Link></article>
